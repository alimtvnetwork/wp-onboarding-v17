...
13. [ ] /learn Ingest `02-spec/02-coding-guidelines/01-cross-language/readme.md` for Rule 9a/9b multi-line parameter and call formatting.
...
18. [ ] /learn Ingest `02-spec/03-error-manage/readme.md` for Result[T] and standardized API envelopes.
