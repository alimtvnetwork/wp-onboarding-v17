...
- Group pending tasks into `.ai-memory/plans/pending/` and `.ai-memory/plans/subtasks/` so that when the executing AI agents run, they see the pending tasks clearly defined.
