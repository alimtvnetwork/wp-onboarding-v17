...
- [ ] Find the root cause of the issue and write it into the "avoid" part of the .ai-memory memory.
...
- [ ] Update the .ai-memory memory with this wrapper and boolean rule so future AI agents do not make the same mistake.
