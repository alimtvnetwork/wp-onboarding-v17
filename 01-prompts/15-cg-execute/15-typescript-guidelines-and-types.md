...
16. [ ] /learn Ingest `02-spec/03-error-manage/01-index.md` for Result[T] and standardized API envelopes.
...
- [ ] Master Guidelines: I have fully read and strictly enforced `02-spec/02-coding-guidelines/02-typescript/` and `.lovable/coding-guidelines.md`.
