...
- `.ai-memory/memory/features/error-history/persistence.md`
- `.ai-memory/memory/features/error-history/multi-error-ui.md`
- `.ai-memory/memory/architecture/frontend/click-tracking.md`
