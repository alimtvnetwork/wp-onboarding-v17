...
**Solution:** Created `02-spec/response-envelope/envelope.schema.json` (JSON Schema Draft 2020-12, v1.0.0) as single source of truth. Added `$schema` references to all 5 sample JSON files. Added schema version comments to Go/TS/PHP implementations.

**Files:** `02-spec/response-envelope/envelope.schema.json`, sample files, implementation files
