...
| # | Task | Spec | Status |
|---|------|------|--------|
| 9 | -d: Skip PHP propagation when no wp-plugins/ changes | `02-spec/02-app-issues/37` | ✅ Done |
| 10 | Redeploy to fix plugin_slug error (v2.30.0) | `02-spec/02-app-issues/36` | Blocked (user) |
...
*Master plan details in `plan.md` (repo root). Specs in `02-spec/02-app-issues/`.*
