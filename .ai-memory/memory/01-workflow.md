...
> **Location:** `.ai-memory/memory/01-workflow.md`  
> **Updated:** 2026-04-01
...
The root `plan.md` is the **master roadmap and backlog** with prioritized phases (A–M), next task selection, and suggestion cross-references. All completed plans are archived in `.ai-memory/plan/completed/`.

**Status overview:** `.ai-memory/plan/active.md` — Dashboard UX fix complete, H-3 scaffolded  
**Pending tasks:** `.ai-memory/memory/workflow/pending-tasks.md` — deployment blockers + medium/low priority items

**Completed plans (in `.ai-memory/plan/completed/`):**
...
All suggestions are tracked in a single file: `.ai-memory/memory/suggestions/01-suggestions-tracker.md`

Completed suggestion details are in `.ai-memory/memory/suggestions/completed/01-completed-suggestions.md`.
...
- `02-spec/00-ai-handoff-complete-context.md` — Complete AI handoff document (706 lines)
- `02-spec/01-app/` — Application specs, formatting rules
- `02-spec/02-app-issues/` — 42 issue write-ups with root cause + prevention
- `02-spec/04-coding-guidelines/` — DRY principles
- `02-spec/05-typescript-standards/` — TypeScript standards
- `02-spec/06-golang-standards/` — Go standards
- `02-spec/07-php-standards/` — PHP standards
- `02-spec/08-error-manage/` — Error handling, modal, envelope
- `02-spec/09-wordpress/` — All WordPress plugin specs (features, dev, publishing, QUpload, cloud storage, log retrieval)
- `02-spec/10-features/` — Feature specifications
- `02-spec/12-feedback-report-feature/` — Feedback report
- `02-spec/13-powershell-integration/` — PowerShell runner
- `02-spec/14-e2-activity-feed/` — Activity audit log
- `02-spec/15-generic-enforce/` — Cross-language type enforcement
- `02-spec/16-user-management/` — User management (4 spec files)
- `02-spec/17-parallel-powershell-scripts/` — Parallel PowerShell scripts
...
1. **Read `02-spec/00-ai-handoff-complete-context.md`** — Complete project knowledge transfer
2. **Read root `plan.md`** — Master roadmap with next task selection
3. **Read `.ai-memory/plan/active.md`** — Current status and completed phases
4. **Read `.ai-memory/memory/02-project-context.md`** — Project overview & architecture
...
2. Check memory files in `.ai-memory/memory/architecture/` for established patterns
3. Review coding standards in `.ai-memory/memory/coding-standards/`
