...
4. **Why the existing spec did not prevent it:** The exemption was listed in `.ai-memory/memory/architecture/php/plugin-identity-standard.md` under "Codebase Audit — Confirmed Clean" but was not called out as a top-level rule in the spec files under `../01-app/`.
...
4. **Spec references:**
   ...
   - `.ai-memory/memory/architecture/php/plugin-identity-standard.md` — existing exemption list
