...
> **References:** `../01-app/formatting-rules-reference.md`, `.ai-memory/memory/architecture/php/naming-conventions.md`, `.ai-memory/memory/architecture/database/pascal-case-naming-convention.md`
