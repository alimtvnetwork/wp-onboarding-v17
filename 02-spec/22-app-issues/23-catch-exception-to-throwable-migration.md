...
4. **References to updated spec sections:** `.ai-memory/memory/coding-standards/php-exception-handling.md`, `.ai-memory/memory/architecture/php/coding-standards-semantic-and-safety.md`
