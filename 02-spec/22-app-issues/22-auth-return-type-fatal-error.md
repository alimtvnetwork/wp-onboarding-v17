...
4. **References to updated spec sections:**
   - `02-spec/02-app-issues/22-auth-return-type-fatal-error.md` (this file)
   - `.ai-memory/memory/issues-fixed/00-index.md` (updated)
   - `.ai-memory/memory/coding-standards/` (new memory entry)
...
- [x] Issue write-up created under `02-spec/02-app-issues/`
- [x] Memory updated with summary and prevention rule
- [x] Index updated in `.ai-memory/memory/issues-fixed/00-index.md`
