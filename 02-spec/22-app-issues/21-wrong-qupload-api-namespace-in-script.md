...
- **Why the spec didn't prevent it:** The QUpload spec (`02-spec/15-qupload-plugin/03-powershell-script.md`) documented the endpoint as `POST /wp-json/qupload/v1/upload` — the spec itself had the wrong namespace.
...
6. **Fixed spec** (`02-spec/15-qupload-plugin/03-powershell-script.md`)
...
- [x] Spec updated (`02-spec/15-qupload-plugin/03-powershell-script.md`)
