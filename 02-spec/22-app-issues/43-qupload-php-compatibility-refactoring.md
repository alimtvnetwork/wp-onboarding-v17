...
These rules are enforced by the QUpload validator and documented in the project's coding standards at `.ai-memory/memory/coding-standards/php-compatibility-constraint.md` and `02-spec/13-powershell-integration/06-php-known-issues.md`.
