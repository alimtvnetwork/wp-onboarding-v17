...
- [Response Envelope Spec](02-spec/07-error-manage/05-response-envelope/readme.md)
- [Envelope JSON Schema](02-spec/07-error-manage/05-response-envelope/envelope.schema.json)
- [ADR #7: JSON Schema Strategy](02-spec/07-error-manage/05-response-envelope/adr.md)
- [CHANGELOG](02-spec/07-error-manage/05-response-envelope/changelog.md)
