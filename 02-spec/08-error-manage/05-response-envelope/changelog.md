...
- Fixed `CapturedError` in `02-spec/error-handling/readme.md` — removed incorrect top-level `delegatedRequestServer` field; data is accessed via `envelopeErrors.DelegatedRequestServer`.
- Fixed `CapturedError` in `02-spec/error-modal/readme.md` — same correction, added clarifying comment.
...
- **Updated `02-spec/error-handling/readme.md`** (v2.0.0) — 3-hop architecture, DelegatedRequestServer injection flow, E8000 error code range.
- **Updated `02-spec/error-modal/readme.md`** (v2.0.0) — DelegatedRequestServer UI rendering in Stack/Request/Traversal tabs.
