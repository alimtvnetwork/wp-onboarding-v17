...
**Schema location:** `02-spec/07-error-manage/05-response-envelope/envelope.schema.json`  
**Version:** v1.0.0  
**Referenced by:**
...
- [02-spec/response-envelope/readme.md](./readme.md) — Canonical specification
- [02-spec/response-envelope/changelog.md](./changelog.md) — Migration timeline
- [02-spec/response-envelope/envelope.schema.json](./envelope.schema.json) — JSON Schema (Draft 2020-12) source of truth
- [02-spec/response-envelope/configurability.md](./configurability.md) — Debug toggle rules
