...
| `src/hooks/useDedupRegistry.ts` | dedup-registry query (inline error UI with retry in DedupRegistryPanel) |
...
- [Coding Standards Memory](../../../.ai-memory/memory/coding-standards/frontend-query-error-handling.md) — Quick-reference rule
